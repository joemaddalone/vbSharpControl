...
Public Class jq
    ...
    Shared liveAction As Func(Of String, String, String, String) = Function(bind, selector, action) "$(document).on('" & selector & "','" & bind & "',function(event){event.preventDefault();" & action & "});"
